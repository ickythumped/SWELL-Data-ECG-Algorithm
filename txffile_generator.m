...
[totalData1, HR_data1, ~] = myDoReadData...
    ("D:\4th sem\Physiological Signal Processing\SWELL Dataset\Data\pp25_c3.S00");
...
%% file write
fileID = fopen('D:\4th sem\Physiological Signal Processing\SWELL Dataset\Data\rr_peaks_pp25-I.txt','w');
fprintf(fileID,'%4.4f\r\n', u');
fclose(fileID);