function [dsquaref_mat] = dsquaref(dsquaref_reg1_mat, dsquaref_reg2_vec, dsquaref_reg3_val)
...
for a = 1:nparams+1
    ...
    for b = 1:nparams+1
        %reg1
        if (a == 1 && b == 1)
            dsquaref_reg1_mat(a,b) = dsquaref_dmusquare;
        elseif (a ~= 1 && b == 1)
            dsquaref_reg1_mat(a,b) = dsquaref_dmusquare*H(k-b+2);
        elseif (a == 1 && b ~= 1)
            dsquaref_reg1_mat(a,b) = dsquaref_dmusquare*H(k-a+2);
        else
